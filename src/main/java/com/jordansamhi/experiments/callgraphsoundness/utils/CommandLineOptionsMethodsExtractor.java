 ...
 * @author Jordan Samhi
 */
public class CommandLineOptionsMethodsExtractor {
    ...
    private static final Triplet<String, String, String> TOOL = new Triplet<>("tool", "t", "Tool to use");

    private static final Triplet<String, String, String> TIMEOUT = new Triplet<>("timeout", "i", "Timeout (in minutes)");
    ...
    private static CommandLineOptionsMethodsExtractor instance;

    public CommandLineOptionsMethodsExtractor() {
    ...
    public static CommandLineOptionsMethodsExtractor v() {
        if (instance == null) {
            instance = new CommandLineOptionsMethodsExtractor();
        }
        return instance;
    }
    ...
    private void initOptions() {
        ...
        final Option tool = Option.builder(TOOL.getValue1())
                .longOpt(TOOL.getValue0())
                .desc(TOOL.getValue2())
                .hasArg(true)
                .argName(TOOL.getValue0())
                .required(true)
                .build();
    ...
    public String getTool() {
        return cmdLine.getOptionValue(TOOL.getValue0());
    }
    ...
    public String getTimeout() {
        return cmdLine.getOptionValue(TIMEOUT.getValue0());
    }
