 ...
 * @author Jordan Samhi
 */
public class CommandLineOptionsInstrumenter {
    ...
    private static CommandLineOptionsInstrumenter instance;

    public CommandLineOptionsInstrumenter() {
    ...
    public static CommandLineOptionsInstrumenter v() {
        if (instance == null) {
            instance = new CommandLineOptionsInstrumenter();
        }
        return instance;
    }
