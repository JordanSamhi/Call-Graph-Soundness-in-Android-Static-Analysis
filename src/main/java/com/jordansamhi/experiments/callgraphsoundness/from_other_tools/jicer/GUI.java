...
public class GUI extends Application {
    ...
    private String getRunCmd(boolean escape) {
        ...
        if (this.modeShow.isSelected()) {
            sb.append(" -m " + com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.MODE_SHOW_SLICE);
        } else if (this.modeSliceOut.isSelected()) {
            sb.append(" -m " + com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.MODE_SLICE_OUT);
        } else {
            sb.append(" -m " + com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.MODE_SLICE);
        }
        if (this.jimple.isSelected()) {
            sb.append(" -f " + com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.OUTPUT_FORMAT_JIMPLE);
        } else if (this.none.isSelected()) {
            sb.append(" -f " + com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.OUTPUT_FORMAT_NONE);
        }
        if (this.in.isSelected()) {
            sb.append(" -in");
        ...
        if (Integer.valueOf(this.kLimit.getText())
                .intValue() != com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.DEFAULT_K_LIMIT_FOR_ANALYSIS) {
    ...
    private void loadDefaultOptions() {
        ...
        // Parameters
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getInputApkFile() != null) {
            this.apkChooser.getTextField()
                    .setText(com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getInputApkFile().getAbsolutePath());
        } else {
            this.apkChooser.getTextField().clear();
        }
        final Reference from = com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getFrom();
        if (from != null) {
            this.fromChooser.getTextField().setText(Helper.toString(from));
        } else {
            this.fromChooser.getTextField().clear();
        }
        final Reference to = com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getTo();
        if (to != null) {
            this.toChooser.getTextField().setText(Helper.toString(to));
        } else {
            this.toChooser.getTextField().clear();
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getMode() == com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.MODE_SLICE
                || com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getMode() == null) {
            this.modeSlice.setSelected(true);
        } else {
            this.modeSlice.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getMode() == com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.MODE_SLICE_OUT) {
            this.modeSliceOut.setSelected(true);
        } else {
            this.modeSliceOut.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance()
                .getMode() == com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.MODE_SHOW_SLICE) {
            this.modeShow.setSelected(true);
        } else {
            this.modeShow.setSelected(false);
        }
        if (!com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isIncomplete()
                && !com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isRunnable()) {
        ...
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isRunnable()) {
            this.run.setSelected(true);
        } else {
            this.run.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance()
                .getOutputFormat() == com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.OUTPUT_FORMAT_APK) {
            this.apk.setSelected(true);
        } else {
            this.apk.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance()
                .getOutputFormat() == com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.OUTPUT_FORMAT_JIMPLE) {
            this.jimple.setSelected(true);
        } else {
            this.jimple.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance()
                .getOutputFormat() == com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.OUTPUT_FORMAT_NONE) {
            this.none.setSelected(true);
        } else {
            this.none.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isSimpleInput()) {
            this.si.setSelected(true);
        } else {
            this.si.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isDrawGraphs()) {
            this.dg.setSelected(true);
        } else {
            this.dg.setSelected(false);
        }
        if (!com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isIncludeOrdinaryLibraryPackages()) {
            this.eol.setSelected(true);
        } else {
            this.eol.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isSliceOrdinaryLibraryPackages()) {
            this.sol.setSelected(true);
        } else {
            this.sol.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isSign()) {
            this.sign.setSelected(true);
        } else {
            this.sign.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isFieldFiltering()) {
            this.fff.setSelected(true);
        } else {
            this.fff.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isContextSensitiveRefinement()) {
            this.csr.setSelected(true);
        } else {
            this.csr.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isStrictThreadSensitivity()) {
            this.sts.setSelected(true);
        } else {
            this.sts.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isOverapproximateStubDroid()) {
            this.os.setSelected(true);
        } else {
            this.os.setSelected(false);
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().isRecordStatistics()) {
        ...
        this.kLimit.setText(String.valueOf(com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getkLimit()));
        this.maxMemory.setText(String.valueOf(com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getMaxMemory() / 1000));
        this.stackSize.setText(String.valueOf(com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getStackSize()));
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getInputEdges() != null) {
            this.inputEdgesChooser.getTextField()
                    .setText(com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getInputEdges().getAbsolutePath());
        } else {
            this.inputEdgesChooser.getTextField().clear();
        }
        if (com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getOutputFile() != null) {
            this.outputChooser.getTextField()
                    .setText(com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.Parameters.getInstance().getOutputFile().getAbsolutePath());
        } else {
