...
import com.jordansamhi.experiments.callgraphsoundness.from_other_tools.jicer.dg.Edge;
...
public class SDGForwardSlicer extends SDGSlicer {
    ...
    /**
     * @param ignoreAlways true: ignore if the ignoreEdgeType is contained, false: only ignore if the ignoreEdgeType is the only assigned type
     */
    @Override
